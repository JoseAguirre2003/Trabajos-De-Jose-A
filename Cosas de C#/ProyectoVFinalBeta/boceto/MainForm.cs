...
namespace ProyectoV2
{
	...
	public partial class MainForm : Form
	{
		...
		public MainForm()
		{
			...
			btnReportIngres.Click += new EventHandler(btnReporteIngresClick);
		...
		void btnReporteIngresClick(object sender, EventArgs e){
			FormConsultaIngresos vent = new FormConsultaIngresos(coleccionPrestam);
			vent.ShowDialog();
		}
		
		void btnreportesPrestamos_Click(object sender, EventArgs e){
			FormConsultaPrestamo vent = new FormConsultaPrestamo(coleccionPrestam);
			vent.ShowDialog();
		}
