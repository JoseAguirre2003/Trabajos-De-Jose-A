...
namespace ProyectoV2
{
	...
	public partial class MainForm : Form
	{
		...
		ColeccionPrestamo coleccionPrestam = new ColeccionPrestamo();
		...
		{
			FormClient vent2= new FormClient(coleccionClient);
			vent2.Show();
		}
		
		void btnPrestamo_Click(object sender, EventArgs e){
			FormPrestamo vent3 = new FormPrestamo(coleccionDVD, coleccionClient, coleccionPrestam);
			vent3.Show();
		}
