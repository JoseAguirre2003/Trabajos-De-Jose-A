...
namespace ProyectoV2.Classes
{
	public class Cliente
	{
		...
		public Cliente(String cedula, String nombres, String apellido, DateTime fechaNacim, String direccion, String correo, String numeroCasa, String numeroMovil, DateTime fechaRegist){
			this.cedula = cedula;
