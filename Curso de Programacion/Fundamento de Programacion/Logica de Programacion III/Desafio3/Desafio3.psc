...
SubAlgoritmo Menu(eleccion Por Referencia)
	...
	Definir repet, repetSoN Como Logico
			...
			1:Repetir
				...
				Repetir
					...
					Si (confirmacion = "S") o (confirmacion = "s") Entonces
						repet = Verdadero
						repetSoN = Falso
					SiNo si (confirmacion = "N") o (confirmacion = "n")
							repet = Falso
							repetSoN = Falso
						Sino
							Mostrar "Tiene que pone un valor valido S o N, por favor vuelva a intentar"
							repetSoN = Verdadero
						FinSi	
					FinSi
				Hasta Que repetSoN = Falso
